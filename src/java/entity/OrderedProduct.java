...
@NamedQueries({
    ...
    @NamedQuery(name = "OrderedProduct.findByDeletethis", query = "SELECT o FROM OrderedProduct o WHERE o.deletethis = :deletethis")})
public class OrderedProduct implements Serializable {
    ...
    public String getDeletethis() {
        return deletethis;
    }

    public void setDeletethis(String deletethis) {
